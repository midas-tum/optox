...
class TestAveragepooling1dFunction(unittest.TestCase):
    def _run_test(self, dtype, padding_mode):
        # test averagepooling1d and averagepooling1d_backward
        pool_size = (2,)
        strides = (2,)
        alpha = 1
        beta = 1
        ...
        out_complex = optoth.averagepooling.Averagepooling1dFunction.apply(x, pool_size, pads, strides, dilations_rate, alpha,
                                                                     beta, padding_mode,
                                                                     t_dtype, False)
...
class TestAveragepooling2dFunction(unittest.TestCase):
    def _run_test(self, dtype, padding_mode):
        # test averagepooling2d and averagepooling2d_backward
        pool_size = (2, 2)
        strides = (2, 2)
        alpha = 1
        beta = 1
        ...
        out_complex = optoth.averagepooling.Averagepooling2dFunction.apply(x, pool_size, pads, strides, dilations_rate, alpha,
                                                                     beta, padding_mode,
                                                                     t_dtype, False)
...
class TestAveragepooling3dFunction(unittest.TestCase):
    def _run_test(self, dtype, padding_mode):
        # test averagepooling3d and averagepooling3d_backward
        pool_size = (2, 2, 2)
        strides = (2, 2, 2)
        alpha = 1
        beta = 1
        ...
        out_complex = optoth.averagepooling.Averagepooling3dFunction.apply(x, pool_size, pads, strides, dilations_rate, alpha,
                                                                     beta, padding_mode,
                                                                     t_dtype, False)
...
class TestAveragepooling4dFunction(unittest.TestCase):
    def _run_test(self, dtype, padding_mode):
        # test averagepooling4d and averagepooling4d_backward
        pool_size = (2, 2, 2, 2)
        strides = (2, 2, 2, 2)
        alpha = 1
        beta = 1
        ...
        out_complex = optoth.averagepooling.Averagepooling4dFunction.apply(x, pool_size, pads, strides, dilations_rate, alpha,
                                                                     beta, padding_mode,
                                                                     t_dtype, False)
