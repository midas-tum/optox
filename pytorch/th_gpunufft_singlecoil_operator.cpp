///@file th_gpunufft_singlecoil_operator.cpp
///@brief PyTorch wrappers for singlecoil gpuNUFFT operator
...
template<typename T>
at::Tensor forward(optox::GPUNufftSingleCoilOperator<T> &op, at::Tensor th_img, at::Tensor th_trajectory, at::Tensor th_dcf)
{
...
template<typename T>
at::Tensor adjoint(optox::GPUNufftSingleCoilOperator<T> &op, at::Tensor th_rawdata, at::Tensor th_trajectory, at::Tensor th_dcf)
{
    typedef typename optox::type_trait<T>::complex_type complex_type;
    typedef typename optox::type_trait<T>::real_type real_type;
