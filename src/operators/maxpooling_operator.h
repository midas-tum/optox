...
template <typename T>
    class OPTOX_DLLAPI MaxPooling1d_Operator : public IOperator
    {
public:

        /** Constructor.
         */
        MaxPooling1d_Operator(
            int& height_in, 
            int& kernel_h, 
            int& stride_h, 
            ...
            int& pad_h, 
            int& dilation_rate_h, 
            int& batch,  int& with_indices, int& ceil_mode, const std::string &padding_mode) : IOperator(),
        ...
        /** Destructor */
        virtual ~MaxPooling1d_Operator()
        {
        }


        MaxPooling1d_Operator( MaxPooling1d_Operator const & )    = delete;
        void operator = ( MaxPooling1d_Operator const & )        = delete;
...
private:
    ...
    template <typename T>
    class OPTOX_DLLAPI MaxPooling2d_Operator : public IOperator
    {
public:

        /** Constructor.
         */
        MaxPooling2d_Operator(
        ...
        /** Destructor */
        virtual ~MaxPooling2d_Operator()
        {
        }


        MaxPooling2d_Operator( MaxPooling2d_Operator const & )    = delete;
        void operator = ( MaxPooling2d_Operator const & )        = delete;
...
private:
    ...
    template <typename T>
    class OPTOX_DLLAPI MaxPooling3d_Operator : public IOperator
    {
public:
        ...
        /** Constructor.
         */
        MaxPooling3d_Operator( int& height_in, int& width_in, int& depth_in,
        ...
        /** Destructor */
        virtual ~MaxPooling3d_Operator()
        {
        }


        MaxPooling3d_Operator( MaxPooling3d_Operator const & )    = delete;
        void operator = ( MaxPooling3d_Operator const & )        = delete;
...
private:
    ...
    template <typename T>
    class OPTOX_DLLAPI MaxPooling4d_Operator : public IOperator
    {
public:
        ...
        /** Constructor.
         */
        MaxPooling4d_Operator( int& time_in, int& height_in, int& width_in, int& depth_in,
        ...
        /** Destructor */
        virtual ~MaxPooling4d_Operator()
        {
        }


        MaxPooling4d_Operator( MaxPooling4d_Operator const & )    = delete;
        void operator = ( MaxPooling4d_Operator const & )        = delete;
         int calculateOutShape(int size_in, int kernel_, int dilation_rate_, int stride_, int pad_) const
        {
        int effective_filter_size = (kernel_ - 1) * dilation_rate_ + 1;
