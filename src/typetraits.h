...
template<> struct OPTOX_DLLAPI type_trait<double2>
{
...
template<> struct OPTOX_DLLAPI type_trait<float>
{
  /** Make float2 from a single float value. */
  static inline __host__ __device__ float2 make_complex(float x)
  {
...
template<> struct OPTOX_DLLAPI type_trait<double>
{
  /** Make float2 from a single float value. */
  static inline __host__ __device__ double2 make_complex(double x)
  {
...
template<typename PixelType>
OPTOX_DLLAPI inline __host__ __device__ typename optox::type_trait<PixelType>::complex_type complex_multiply(
    const typename optox::type_trait<PixelType>::complex_type& src1,
    const typename optox::type_trait<PixelType>::complex_type& src2)
{
  typename optox::type_trait<PixelType>::complex_type dst;
...
template<typename PixelType>
OPTOX_DLLAPI inline __host__ __device__ typename optox::type_trait<PixelType>::complex_type complex_multiply_conjugate(
    const typename optox::type_trait<PixelType>::complex_type& src1,
    const typename optox::type_trait<PixelType>::complex_type& src2)
{
  typename optox::type_trait<PixelType>::complex_type dst;
...
template<typename PixelType>
OPTOX_DLLAPI inline __host__ __device__ typename optox::type_trait<PixelType>::complex_type complex_conjugate(
    const typename optox::type_trait<PixelType>::complex_type& src)
{
  typename optox::type_trait<PixelType>::complex_type dst;
  dst.x = src.x;
  dst.y = -src.y;
